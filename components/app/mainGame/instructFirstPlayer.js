    ...
    <>
      ...
      <div id={styles.mainContent}>
        ...
        <p className={styles.text}>
          {" "}
          Think of a word and when you are ready click the{" "}
          <span id={styles.ready}>&apos;Ready&apos;</span> button
        </p>
        <p className={`${styles.text} hint`}>
          Warning: Make sure {secondPlayer} doesn&apos;t find out about it or
          you&apos;ll lose.
        </p>
        <DarkButton id={styles.readyBtn} onClick={ClickHandler}>
          {" "}
          Ready{" "}
        </DarkButton>
      </div>
