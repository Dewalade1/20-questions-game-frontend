      ...
      <div>
        <div id={styles.guessArea}>
          <p className={styles.text}>
            {" "}
            {secondPlayer}&apos;s guess:{" "}
            <span className="green">{mainGameState.guess}</span>
          </p>
        ...
        <div id={styles.buttonArea}>
          <RedButton className={styles.button} onClick={NoBtnClickHandler}>
            <ClearRoundedIcon className={styles.buttonIcon} /> No
          </RedButton>
          <GreenButton className={styles.button} onClick={YesBtnClickHandler}>
            <CheckRoundedIcon className={styles.buttonIcon} /> Yes
          </GreenButton>
        </div>
      </div>
    </>
